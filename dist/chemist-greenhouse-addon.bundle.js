...
/***/ "./src/blocks/find-store-in-gmap.js":
/*!******************************************!*\
  !*** ./src/blocks/find-store-in-gmap.js ***!
  \******************************************/
/***/ (() => {
...
(function (w, $) {
  ...
  var OurStores = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var OurStoresBlocks, Stores;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            OurStoresBlocks = $('.our-stores-block');
            if (!(OurStoresBlocks.length == 0)) {
              _context2.next = 3;
              break;
            }
          ...
          case 8:
            OurStoresBlocks.each(function () {
              var $self = $(this);
              var _Stores$0$gmap_locati = Stores[0].gmap_location,
                lat = _Stores$0$gmap_locati.lat,
                lng = _Stores$0$gmap_locati.lng;
              var initLatLng = {
                lat: lat,
                lng: lng
              };
              var map = new google.maps.Map($self.find('.__GMAP_HERE')[0], {
                zoom: 14,
                center: initLatLng
              });
              _toConsumableArray(Stores).forEach(function (item, _index) {
                var _item$gmap_location = item.gmap_location,
                  lat = _item$gmap_location.lat,
                  lng = _item$gmap_location.lng;
                var contentString = "\n        <div class=\"cga-gmap-info-window\">\n          <h4>".concat(item.name, "</h4>\n          ").concat(item.opening_time, "\n          <a class=\"cga-button-link\" href=\"").concat(item.botton_url, "\">").concat(item.button_text, "</a>\n        </div>");
                var infowindow = new google.maps.InfoWindow({
                  content: contentString,
                  ariaLabel: item.name
                });
                var icon = {
                  url: CGA_PHP_DATA.marker_icon,
                  // url
                ...
                var marker = new google.maps.Marker({
                  ...
                  map: map,
                  title: "".concat(item.name, " | ").concat(item.gmap_location.address),
                  icon: icon
                });
...
/* harmony import */ var _blocks_find_store_in_gmap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blocks/find-store-in-gmap */ "./src/blocks/find-store-in-gmap.js");
/* harmony import */ var _blocks_find_store_in_gmap__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_blocks_find_store_in_gmap__WEBPACK_IMPORTED_MODULE_1__);
/**
 * JS Script
 * 
 * @author Mike
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkchemist_greenhouse_addon"] = self["webpackChunkchemist_greenhouse_addon"] || [];
